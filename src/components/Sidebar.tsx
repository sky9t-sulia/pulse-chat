...
function ConversationItem({
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 text-sm text-gray-300 truncate">{conversation.title}</span>
      <button
    ...
    <aside className="w-64 flex-shrink-0 bg-sidebar flex flex-col h-full border-r border-border">
      ...
      <div className="p-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-transparent border border-border-light rounded-lg text-gray-300 hover:bg-sidebar-hover transition-all text-sm"
        >
      ...
      <div className="p-3 border-t border-border space-y-1">
        ...
        <button
          ...
          className="sidebar-item w-full flex items-center gap-2 px-3 py-2 rounded-lg text-gray-400 hover:text-gray-200 text-sm"
        >
